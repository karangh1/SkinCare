  ...
  return (
    <View style={{backgroundColor:"white",flex:1}}>
        <View style={{display:"flex",flexDirection:"row",paddingTop:50,justifyContent:"center"}}>
             <Text style={{fontSize:30,fontWeight:"bold",color:"#5356FF"}}>Login</Text>
        </View>
        ...
        <View style={{paddingHorizontal:30,paddingVertical:20,display:"flex",gap:10}}>
           ...
           <TouchableOpacity onPress={tab}  style={{display:"flex",paddingVertical:10, borderRadius:10,paddingHorizontal:10,justifyContent:"center",alignItems:"center",marginTop:10,backgroundColor:"#5356FF"}}>
              <View style={{display:"flex",flexDirection:"row",gap:10,alignItems:"center",borderRadius:30}}>
                ...
                <View style={{display:"flex",flexDirection:"row",justifyContent:"center"}}>
                    ...
                    <TouchableOpacity  onPress={goto} >
                        <Text style={{color:"#5356FF"}}> SignUp</Text>
                    </TouchableOpacity>
                </View>
        </View>
    </View>
